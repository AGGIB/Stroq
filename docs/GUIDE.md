...
- **Taint-aware policy.** The decision about an action knows whether the agent has read something suspicious in this session. Seventeen action classes, one ordered YAML policy, first match wins.
